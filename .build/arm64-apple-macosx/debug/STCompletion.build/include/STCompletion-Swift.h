...
#ifndef STCOMPLETION_SWIFT_H
#define STCOMPLETION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="STCompletion",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC12STCompletion26STCompletionViewController")
...
@class NSTableView;
@interface STCompletionViewController (SWIFT_EXTENSION(STCompletion)) <NSTableViewDataSource>
...
@interface STCompletionViewController (SWIFT_EXTENSION(STCompletion)) <NSTableViewDelegate>
...
@class NSWindow;
SWIFT_CLASS("_TtC12STCompletion28STCompletionWindowController")
